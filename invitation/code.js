...
var parallaxPlaceholder = $('#parallax-placeholder');
var strength = 0.2,
isMobile = false;
...
function orientationSet(e)
{
	if (screen.orientation.type === "landscape-primary") {
	  console.log("That looks good.");
	  parallaxPlaceholder.hide();
	  $("body").addClass("active-invitation");
	  invitation.show();
	} else {
	  console.log("Bad orientation.");
	  invitation.hide();
	  $("body").removeClass("active-invitation");
	  parallaxPlaceholder.show();
	}
...
screen.orientation.onchange = orientationSet;

$(document).ready(function(){orientationSet();});